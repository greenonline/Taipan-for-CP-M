...
TODO: Where:
 ...
 - (845, 849), 850, 851 : revert to original positive logic?
 - Between bottom of cargo table and market prices
 - Cleanup routine 1338-1370

```none
845 if x$="y" then print:print a$
849 if x$<>"y" then print a$
850 if(tr=0 and l=0) or x$ = "y" and l = 0 then print: print a$:gosub 780
851 if(tr=0 and l=0) or x$ = "y" and l = 0 then print a$:print:print
```
...
```none
845 if x$="y" then print:print a$
845 if x$="y" then print
845 if x$="y" then rem print
849 if x$<>"y" then print a$
849 if x$<>"y" then print
849 if x$<>"y" then rem print
850 if(tr=0 and l=0) or x$ = "y" and l = 0 then print: print a$:gosub 780
850 if(tr=0 and l=0) or x$ = "y" and l = 0 then gosub 780
851 if(tr=0 and l=0) or x$ = "y" and l = 0 then print a$:print:print
851 if(tr=0 and l=0) or x$ = "y" and l = 0 then rem print a$:print:print
```

#### Missing blank line

Due to big number routine, similar to an issue above (related to semicolon and `A$`?):

```none
833 print "you will donate ";:q = dn:gosub 1330
834 print "to the temple of tin hau, the"
834 print:print "to the temple of tin hau, the"
```
